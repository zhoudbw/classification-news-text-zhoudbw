...
file_classes = open("model_res1\classes.txt", "r", encoding="utf-8")
...
def get_features(test_single_example):
    ...
    tokenizer = BertTokenizer.from_pretrained('model_res1')
...
def main(line):
    ...
    return model_time, run_time, possible_list


# 在测试集合上预测
if __name__ == '__main__':
    line = '宝贝梦网国战在即 号召各国招兵买马'
    model_time, run_time, possible_list = main(line)
    print('类别：', possible_list)
